...
public class WebDriverUtility {
	...
	public void waitForPageToLoad(WebDriver driver) {
		driver.manage().timeouts().implicitlyWait(IConstants.implicitlyWait_TimeOut, TimeUnit.SECONDS);
	}
	/**
	...
	public void waitForPageToLoadForJSElement(WebDriver driver) {
		driver.manage().timeouts().setScriptTimeout(IConstants.explicitlyWait_TimeOut, TimeUnit.SECONDS);
	}
